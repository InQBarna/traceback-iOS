...
If you want a custom deep link scheme (instead of `https://mydomain.com`):

1. Open `Info.plist`
2. Find `CFBundleURLSchemes`
3. Change `https` to your desired scheme
...
1. Create a test link in your browser:
   ```
   https://YOUR-DOMAIN.firebaseapp.com/welcome?link=https://mydomain.com/home
   ```
...
1. Send yourself this link via Messages:
   ```
   https://YOUR-DOMAIN.firebaseapp.com/promo?link=https://mydomain.com/products/123
   ```

2. Tap the link with the app already installed

3. The app should open and receive "https://mydomain.com/products/123" indicating to 
