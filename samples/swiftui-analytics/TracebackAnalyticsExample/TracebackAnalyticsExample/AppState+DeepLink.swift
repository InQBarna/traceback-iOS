...
//
//  Deep link handling methods for AppState with Firebase Analytics integration
//
...
extension AppState {
    ...
    /// Resolves campaign links via the Traceback SDK and logs to Firebase Analytics
